                    ...
                    <div class="my-4">
                      ...
                      <div class="p-2 mb-2 w-full lg:w-2/3 mx-auto ">
                        <div class="relative flex justify-around">
                          <div class="mr-2"><input type="radio" name="type" value="1" checked >
                            追加</div>
                            <div class="mr-2"><input type="radio" name="type" value="2" checked >
                              削減</div>
                        </div>
                      </div>
                      ...
                      <div class="p-2 mb-2 w-full lg:w-2/3 mx-auto">
                        <div class="relative">
                          ...
                          <input type="number" id="quantity" name="quantity" value="0" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-yellow-500 focus:bg-white focus:ring-2 focus:ring-yellow-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                      ...
                      <div class="p-2 mb-2 w-full lg:w-2/3 mx-auto">
                        <div class="relative">
                          <label for="shop_id" class="leading-7 text-sm text-gray-600">販売する店舗</label><br>
                          <select name="shop_id">
