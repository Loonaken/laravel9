                ...
                <form method="POST" action="{{route('owner.products.store')}}">
                    ...
                    <div class="my-4">
                      ...
                      <div class="flex p-2 w-full">
                        <button type="button" onclick="location.href='{{route('owner.shops.index')}}'" class="flex mx-auto text-black bg-gray-300 border-0 py-2 px-8 focus:outline-none hover:bg-gray-200 rounded text-lg">戻る</button>
