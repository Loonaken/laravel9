                          ...
                          @foreach ($expiredOwners as $owner)
                            ...
                            <tr>
                              ...
                              <td class="w-40 mt-1 flex  justify-end">
                                <a href='#' data-id="{{$owner->id}}" onclick="deletePost(this)" type="submit" class="flex mx-auto text-white bg-red-500 border-0 py-2 px-2 focus:outline-none hover:bg-red-600 rounded text-base">完全に削除</a>
                              </td>
                            </form>
                            </tr>
                            @endforeach
